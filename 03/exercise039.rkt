...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise039) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
;;; Exercício 39
...
;;; Códigos de testes e exemplos:
;; Colocar o carro na base e início da cena
(place-image CARRO (+ 0 (/ (image-width CARRO) 2)) POS-Y-CARRO BACKGROUND)